...
fun getApproachOptions() :List<CategoryOption> {
    return listOf(
        ...
        CategoryOption("Flexibility", stringResource(id = R.string.a_flex)),
        ...
        CategoryOption("Bodyweight", stringResource(id = R.string.a_weight)),
...
fun getElementsOptions() :List<CategoryOption> {
    return listOf(
        ...
        CategoryOption("Dumbell", stringResource(id = R.string.e_dumbell)),
        ...
        CategoryOption("Jump rope", stringResource(id = R.string.e_rope)),
